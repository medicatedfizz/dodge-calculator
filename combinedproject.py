...
!Hello, !안녕, !ㅎㅇ, !인사 : 인사를 합니다
!total, !전체승률, !승률 (소환사명 혹은 픽창에서 드래그) : 각 소환사별 전체 승률
!kda, !킬뎃, !킬데스 (소환사명 혹은 픽창에서 드래그) : 각 소환사별 최근 10판 kda
!recent_win, !최근, !최근전적, !열판 (소환사명 혹은 픽창에서 드래그) : 각 소환사별 최근 10판 승률
!every, !all, !모두, !전부 (소환사명 혹은 픽창에서 드래그) : 각 소환사별 위 셋 정보
!dodge, !닷지 (소환사명 혹은 픽창에서 드래그) : !every 에 나오는 모든 정보와 이번 게임에서의 승률, 닷지 추천
    """
